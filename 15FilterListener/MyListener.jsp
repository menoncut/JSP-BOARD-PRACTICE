...
<body>
	...
	<form action="">
		...
		<input type="button" value="세션 속성 저장"
		 onclick="formSubmit(this.form, 1);">
		<input type="button" value="세션 속성 삭제"
		 onclick="formSubmit(this.form, 2);">
		<input type="button" value="세션 전체 삭제"
		 onclick="formSubmit(this.form, 3);">
	</form>
</body>
